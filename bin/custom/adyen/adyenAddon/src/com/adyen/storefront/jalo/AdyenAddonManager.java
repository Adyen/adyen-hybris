 ...
 *
 */
package com.adyen.storefront.jalo;
...
import com.adyen.storefront.constants.AdyenAddonConstants;



/**
 * This is the extension manager of the AdyenAddon extension.
 */
public class AdyenAddonManager extends GeneratedAdyenAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyenAddonManager.class.getName());
	 ...
	 */
	public static AdyenAddonManager getInstance()
	{
		return (AdyenAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyenAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyenAddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyenAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyenAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyenAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
