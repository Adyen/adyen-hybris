...
<c:url value="/checkout/multi/get-saved-adyen-payment-methods" var="getSavedAdyenPaymentMethodsUrl"/>
...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
	...
	<div class="span-14 append-1">
		...
		<c:if test="${apiEnabled}">
			...
			<div class="headline clear" id="addPaymentDetailsBillingAddress"><spring:theme code="checkout.multi.paymentMethod.addPaymentDetails.billingAddress"/></div>
		...
		<c:if test="${hppEnabled}">
			<input type="hidden" id="useHPP" name="useHPP" >
			<input type="hidden" id="adyenPaymentBrand" name="adyenPaymentBrand" >
				...
				<c:choose>
					<c:when test="${not empty hppPaymentMethods}">
						<c:forEach items="${hppPaymentMethods}" var="hppPaymentMethod" varStatus="status">
								<button class="positive" style="width:150px;" tabindex="20"  type="button" onclick="payByHPP('${hppPaymentMethod.brandCode}')">
				   ...
				   <c:otherwise>  
						<button class="positive" style="width:150px;" tabindex="20"  type="button" onclick="payByHPP('','')">
