...
<div class="summaryPayment clearfix"  data-security-what-text="${securityWhatText}">
    <ycommerce:testId code="checkout_paymentDetails_text">
            <div class="column append-1">
				...
				<c:choose>
				   <c:when test="${cartData.paymentInfo.useHPP}">
					   <c:if test="${not empty cartData.paymentInfo.adyenPaymentBrand}"> 
			                <ul>
		                 ...
		                 <c:if test="${empty cartData.paymentInfo.adyenPaymentBrand}">
			                <ul>
