...
/**
 */
public interface AdyenAddonControllerConstants
{
	final String ADDON_PREFIX = "addon:/adyenAddon/";
	...
	interface Views
	{
		...
		interface Fragments
		{
			...
			interface Checkout
			{
				...
				String SavedPaymentMethods = ADDON_PREFIX + "fragments/checkout/savedPaymentMethods";
			}
