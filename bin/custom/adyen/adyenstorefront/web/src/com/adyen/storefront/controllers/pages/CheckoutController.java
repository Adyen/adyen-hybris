...
import com.adyen.storefront.facades.order.impl.AdyenExtOrderFacade;
...
public class CheckoutController extends AbstractCheckoutController
{
	...
	private AdyenExtCheckoutFacade checkoutFlowFacade;
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("boletoUrl", ((AdyenExtOrderFacade) orderFacade).getBoletoUrl(orderCode));
