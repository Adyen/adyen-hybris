				...
				<div class="account-section">
					...
					<div
						...
						<form action="">
							...
							<p>Please enter your new email address and confirm with your
								password</p>

							<div class="form-group">
								<label for="">New Email Address</label> <input type="email"
									class="form-control" id="" placeholder="New Email Address">
							</div>
							<div class="form-group">
								<label for="">Re-enter Email Address</label> <input type="email"
									class="form-control" id="" placeholder="New Email Address">
							</div>
							<div class="form-group">
