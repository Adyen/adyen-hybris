 ...
 *  
 */
package com.adyen.commerceservices.jalo;
...
import com.adyen.commerceservices.constants.AdyenCommerceServicesConstants;



/**
 * This is the extension manager of the AdyenCommerceServices extension.
 */
public class AdyenCommerceServicesManager extends GeneratedAdyenCommerceServicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyenCommerceServicesManager.class.getName());
	 ...
	 */
	public static AdyenCommerceServicesManager getInstance()
	{
		return (AdyenCommerceServicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyenCommerceServicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyenCommerceServicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyenCommerceServicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyenCommerceServicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyenCommerceServicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
