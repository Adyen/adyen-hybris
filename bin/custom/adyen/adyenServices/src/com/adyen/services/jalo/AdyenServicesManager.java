 ...
 *  
 */
package com.adyen.services.jalo;
...
import com.adyen.services.constants.AdyenServicesConstants;



/**
 * This is the extension manager of the AdyenServices extension.
 */
public class AdyenServicesManager extends GeneratedAdyenServicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyenServicesManager.class.getName());
	 ...
	 */
	public static AdyenServicesManager getInstance()
	{
		return (AdyenServicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyenServicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyenServicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyenServicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyenServicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyenServicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
