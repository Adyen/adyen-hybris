...
/**
 * This is the extension manager of the Adyenv6b2ccheckoutaddon extension.
 */
public class Adyenv6b2ccheckoutaddonManager extends GeneratedAdyenv6b2ccheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Adyenv6b2ccheckoutaddonManager.class.getName());
	 ...
	 */
	public static Adyenv6b2ccheckoutaddonManager getInstance()
	{
		return (Adyenv6b2ccheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
	 ...
	 */
	public Adyenv6b2ccheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Adyenv6b2ccheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Adyenv6b2ccheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Adyenv6b2ccheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
