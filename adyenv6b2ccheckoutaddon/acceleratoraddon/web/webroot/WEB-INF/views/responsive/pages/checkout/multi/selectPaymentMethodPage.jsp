...
<template:page pageTitle="${pageTitle}" hideHeaderLinks="true">
    <jsp:attribute name="pageScripts">
        ...
        <script type="text/javascript">
            ...
            //Set the allowed cards by using the Directory Lookup response
            var allowedCards = [];
            <c:forEach items="${paymentMethods}" var="paymentMethod">
            <c:if test="${paymentMethod.isCard()}">
            allowedCards.push("${paymentMethod.brandCode}");
            </c:if>
            </c:forEach>
            ...
            $(".submit_silentOrderPostForm").click(function (event) {
                var paymentMethod = $('input[type=radio][name=paymentMethod]').val();
