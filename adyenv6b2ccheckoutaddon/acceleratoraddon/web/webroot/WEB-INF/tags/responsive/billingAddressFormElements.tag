...
<c:choose>
    <c:when test="${country == 'US'}">
        ...
        <formElement:formSelectBox idKey="address.region" labelKey="address.state" path="billingAddress.state" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectState"
    ...
    <c:when test="${country == 'CA'}">
        ...
        <formElement:formInputBox idKey="address.line2" labelKey="address.line2" path="billingAddress.street2" inputCSS="form-control" mandatory="false" tabindex="${tabindex + 5}"/>
        <formElement:formInputBox idKey="address.townCity" labelKey="address.townCity" path="billingAddress.city" inputCSS="form-control" mandatory="true" tabindex="${tabindex + 6}"/>
        <formElement:formSelectBox idKey="address.region" labelKey="address.province" path="billingAddress.state" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectProvince"
                                   items="${regions}" itemValue="isocodeShort" tabindex="${tabindex + 7}" selectCSSClass="form-control"/>
        <formElement:formInputBox idKey="address.postcode" labelKey="address.postcode" path="billingAddress.postalCode" inputCSS="form-control" mandatory="true" tabindex="${tabindex + 8}"/>
        <formElement:formInputBox idKey="address.phone" labelKey="address.phone" path="billingAddress.phoneNumber" inputCSS="form-control" mandatory="false" tabindex="${tabindex + 9}"/>
    </c:when>
    ...
    <c:when test="${country == 'JP'}">
        ...
        <formElement:formSelectBox idKey="address.region" labelKey="address.prefecture" path="billingAddress.state" mandatory="true" skipBlank="false" skipBlankMessageKey="address.selectPrefecture"
