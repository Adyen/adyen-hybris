var AdyenCheckoutHybris = (function () {
    ...
    return {
        ...
        validateForm: function () {
            ...
            if (['eps', 'ideal','onlinebanking_IN'].indexOf(paymentMethod) >= 0) {
        ...
        initiateAmazonPay: function (params) {
            const {amount, deliveryAddress, amazonPayConfiguration} = params;
            const label = this.getVisibleLabel();
            ...
            if (url.searchParams.has('amazonCheckoutSessionId')) {
                ...
                $('.adyen-terms-conditions-check').prop('checked', true);
