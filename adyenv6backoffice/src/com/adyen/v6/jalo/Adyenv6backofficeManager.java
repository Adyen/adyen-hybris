...
import com.adyen.v6.constants.Adyenv6backofficeConstants;
 ...
 */
public class Adyenv6backofficeManager extends GeneratedAdyenv6backofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Adyenv6backofficeManager.class.getName());
	 ...
	 */
	public static Adyenv6backofficeManager getInstance()
	{
		return (Adyenv6backofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
	 ...
	 */
	public Adyenv6backofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Adyenv6backofficeManager called.");
		}
	}
