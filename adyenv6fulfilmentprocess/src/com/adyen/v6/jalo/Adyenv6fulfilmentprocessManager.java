...
public class Adyenv6fulfilmentprocessManager extends GeneratedAdyenv6fulfilmentprocessManager
{
	...
	{
		return (Adyenv6fulfilmentprocessManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Adyenv6fulfilmentprocessConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Adyenv6fulfilmentprocessManager() // NOPMD 
	{
		LOG.debug("constructor of Adyenv6fulfilmentprocessManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Adyenv6fulfilmentprocessManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Adyenv6fulfilmentprocessManager called, current tenant: {}", getTenant().getTenantID());
	}
