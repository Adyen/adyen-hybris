...
public class DefaultAdyenCheckoutFacade implements AdyenCheckoutFacade {
    ...
    public void initializeCheckoutData(Model model) throws ApiException {
        ...
        model.addAttribute("sessionData", getAdyenSessionData());
    ...
    public void initializeSummaryData(Model model) throws ApiException {
        ...
        model.addAttribute(MODEL_COUNTRY_CODE, Objects.nonNull(cartData.getDeliveryAddress()) && Objects.nonNull(cartData.getDeliveryAddress().getCountry()) ? cartData.getDeliveryAddress().getCountry().getIsocode() : null);
    ...
    private boolean isHiddenPaymentMethod(PaymentMethod paymentMethod) {
        ...
        if (paymentMethodType == null || paymentMethodType.isEmpty() ||
                ...
                (ISSUER_PAYMENT_METHODS.contains(paymentMethodType) && !paymentMethodType.equals("onlinebanking_IN"))) {
            return true;
        }
        return false;
    }
