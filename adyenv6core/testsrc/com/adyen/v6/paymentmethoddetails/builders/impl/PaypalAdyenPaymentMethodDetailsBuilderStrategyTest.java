...
public class PaypalAdyenPaymentMethodDetailsBuilderStrategyTest {
    ...
    private static String personalDetails = "firstName lastName Thu Jan 01 01:00:00 CET 1970 666666666 test@test.com";
    @InjectMocks
    ...
    public void buildPaymentMethodDetails_returnPaypalDetailsCorrectlyFilled() {
        ...
        assertThat(((PayPalDetails)result).getPayerID()).isEqualTo(personalDetails);
    }
