...
import com.adyen.commerce.constants.AdyencheckoutaddonspaConstants;



/**
 * This is the extension manager of the Adyencheckoutaddonspa extension.
 */
public class AdyencheckoutaddonspaManager extends GeneratedAdyencheckoutaddonspaManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyencheckoutaddonspaManager.class.getName());
	 ...
	 */
	public static AdyencheckoutaddonspaManager getInstance()
	{
		return (AdyencheckoutaddonspaManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyencheckoutaddonspaConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyencheckoutaddonspaManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyencheckoutaddonspaManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyencheckoutaddonspaManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyencheckoutaddonspaManager called, current tenant: " + getTenant().getTenantID());
		}
	}
