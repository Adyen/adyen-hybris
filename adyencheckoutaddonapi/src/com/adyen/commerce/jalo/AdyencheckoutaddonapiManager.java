...
import com.adyen.commerce.constants.AdyencheckoutaddonapiConstants;



/**
 * This is the extension manager of the Adyencheckoutaddonapi extension.
 */
public class AdyencheckoutaddonapiManager extends GeneratedAdyencheckoutaddonapiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(AdyencheckoutaddonapiManager.class.getName());
	 ...
	 */
	public static AdyencheckoutaddonapiManager getInstance()
	{
		return (AdyencheckoutaddonapiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				AdyencheckoutaddonapiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdyencheckoutaddonapiManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdyencheckoutaddonapiManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of AdyencheckoutaddonapiManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of AdyencheckoutaddonapiManager called, current tenant: " + getTenant().getTenantID());
		}
	}
